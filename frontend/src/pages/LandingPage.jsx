      ...
      <div className="relative rounded-2xl overflow-hidden terminal-window">
        ...
        <div className="border-t border-white/[0.04] px-4 py-2.5 flex flex-wrap items-center gap-6"
          ...
          <div className="ml-auto flex gap-2">
            <button className="text-[9px] font-mono font-bold px-3 py-1.5 rounded-md transition-all bg-success/[0.12] text-success border border-success/25 hover:bg-success/[0.22]">
              LONG
            </button>
            <button className="text-[9px] font-mono font-bold px-3 py-1.5 rounded-md transition-all bg-danger/[0.12] text-danger border border-danger/25 hover:bg-danger/[0.22]">
              SHORT
            </button>
          </div>
        </div>
...
function FeatureCard({ icon, tag, title, desc, delay = 0 }) {
  ...
  return (
    <FadeUp delay={delay} className="h-full">
      <div ref={ref}
        className="group relative glass-card p-6 rounded-2xl h-full overflow-hidden transition-all duration-300 cursor-default hover:-translate-y-1.5 hover:border-white/[0.12] hover:shadow-[0_16px_48px_rgba(0,0,0,0.5)]">
    ...
    <div className="relative min-h-screen overflow-x-hidden" style={{ background: "#050810" }}>
      ...
      <div className="relative z-10">
        ...
        <section className="relative max-w-page mx-auto px-6 md:px-10 pt-[120px] pb-8 text-center">
          ...
          <FadeUp>
            <div className="inline-flex items-center gap-2.5 mb-10 font-mono text-[10.5px] rounded-full px-4 py-1.5 border border-white/[0.07] hover:border-white/[0.14] transition-colors cursor-default"
          ...
          <section className="max-w-page mx-auto px-6 md:px-10 py-16 border-t border-white/[0.04]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-10 md:gap-16">
              {["Citadel Securities","Jump Trading","DRW Cumberland","Two Sigma","GSR Markets","Wintermute"].map(name => (
                <span key={name}
                  className="text-white/[0.11] font-bold text-[12.5px] tracking-tight hover:text-white/[0.24] transition-colors cursor-default select-none grayscale">
                  {name}
                </span>
              ))}
            </div>
        ...
        <section className="max-w-page mx-auto px-6 md:px-10 py-[120px] border-t border-white/[0.04]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FeatureCard delay={0} icon="⚡" tag="WS STREAM" title="Sub-10ms latency"
            ...
            <FeatureCard delay={90} icon="◈" tag="PRO TERMINAL" title="Institutional UI"
            ...
            <FeatureCard delay={180} icon="⬡" tag="FULL STACK" title="Production-ready auth & billing"
              desc="Supabase JWT auth with RLS, Stripe Checkout + Customer Portal, and per-feature paywall gates. Ship your SaaS in hours — not weeks." />
          </div>
        </section>
